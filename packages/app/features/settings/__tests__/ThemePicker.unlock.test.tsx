...
describe('locked-state rendering on free tier', () => {
  it('shows token-spend affordance text when a token is available (L1)', () => {
  ...
  it('shows day-until-next-milestone microcopy when zero tokens available (L2)', () => {
  ...
  it('shows no locked affordances when all themes unlocked (L3)', () => {
  ...
  it('never shows locked affordances on default themes (L4)', () => {
...
describe('token-spend confirm strip', () => {
  it('shows confirm strip when tapping locked theme with tokens (S1)', () => {
    mockStreakState = { ...mockStreakState, unlockTokensEarned: 1, longestStreak: 7 }
    mockUnlockedThemes = []
  ...
  it('calls spendUnlockToken and dismisses strip on confirm (S2)', () => {
    mockStreakState = { ...mockStreakState, unlockTokensEarned: 1, longestStreak: 7 }
    mockUnlockedThemes = []
  ...
  it('dismisses without spending when cancel tapped (S3)', () => {
    mockStreakState = { ...mockStreakState, unlockTokensEarned: 1, longestStreak: 7 }
    mockUnlockedThemes = []
  ...
  it('replaces previous confirm strip when tapping different theme (S4)', () => {
    mockStreakState = { ...mockStreakState, unlockTokensEarned: 1, longestStreak: 7 }
    mockUnlockedThemes = []
...
describe('paid tier', () => {
  it('shows no locked overlays and no "Unlock everything now" on paid tier (P1)', () => {
...
describe('"Unlock everything now" affordance', () => {
  it('renders on free tier and routes to /paid/coming-soon when tapped (U1)', () => {
    mockTier = 'free'
