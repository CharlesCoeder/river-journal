                    ...
                    >
                      ...
                      <YStack paddingTop="$4">
                        <Text
                          ...
                          onPress={
                            selectedMode ? () => void confirmEncryptionModeSelection() : undefined
                          }
                        >
                          Continue
                        </Text>
                  ...
                  {!isTrustBrowserStep && step !== 'choice' && (
                    ...
                    >
                      <E2EPasswordForm
                        ...
                        onBack={
                          isLegacyE2EUnlock ? cancelEncryptionSetup : returnToEncryptionChoice
                        }
                        ...
                        title={
                          isSinglePasswordUnlock ? 'Unlock Encryption' : 'Create Encryption Key'
                        }
                        description={
                          isSinglePasswordUnlock
                    ...
                    >
                      ...
                      >
                        ...
                        <Text
                          ...
                          textAlign="center"
                        >
                          We can securely save your key in this browser. You won't need to re-enter
                          your password every time you open the app here.
                        </Text>
                        <Text
                          fontFamily="$body"
                          fontSize={11}
                          ...
                          textAlign="center"
                        >
                          If browser data is cleared, you'll need your password again. You can
                          revoke trust in Settings.
                        </Text>
                      </YStack>
