 ...
 *   - 'change': User who already has a password updating it
...
import { updatePassword } from 'app/utils'
...
export function AddPasswordForm({ mode, onSuccess, onCancel }: AddPasswordFormProps) {
  ...
  }, [password, confirmPassword, validatePassword, validateConfirmPassword, onSuccess])
